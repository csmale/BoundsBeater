...
Public Partial Class HeaderBlock
    ...
    Private _bbox As OSMPBF.HeaderBBox =Nothing
    <Global.ProtoBuf.ProtoMember(1, IsRequired:=False, Name:="bbox", DataFormat:=Global.ProtoBuf.DataFormat.Default)> _ 
    <Global.System.ComponentModel.DefaultValue(CType(Nothing, OSMPBF.HeaderBBox))> _ 
    Public Property bbox As OSMPBF.HeaderBBox
		Get 
			Return _bbox
		End Get
	
		Set(value As OSMPBF.HeaderBBox)
		_bbox = value 
...
Public Partial Class PrimitiveBlock
    ...
    Private _stringtable As OSMPBF.StringTable
    <Global.ProtoBuf.ProtoMember(1, IsRequired:=True, Name:="stringtable", DataFormat:=Global.ProtoBuf.DataFormat.Default)> _ 
    Public Property stringtable As OSMPBF.StringTable
		Get 
			Return _stringtable
		End Get
	
		Set(value As OSMPBF.StringTable)
		_stringtable = value 
			
		End Set
	End Property
    
    Private ReadOnly _primitivegroup as Global.System.Collections.Generic.List(Of OSMPBF.PrimitiveGroup) = New Global.System.Collections.Generic.List(Of OSMPBF.PrimitiveGroup)()
		
	<Global.ProtoBuf.ProtoMember(2, Name:="primitivegroup", DataFormat:=Global.ProtoBuf.DataFormat.Default)> _
		Public ReadOnly Property primitivegroup As Global.System.Collections.Generic.List(Of OSMPBF.PrimitiveGroup)
...
Public Partial Class PrimitiveGroup
    ...
    Private ReadOnly _nodes as Global.System.Collections.Generic.List(Of OSMPBF.Node) = New Global.System.Collections.Generic.List(Of OSMPBF.Node)()
		
	<Global.ProtoBuf.ProtoMember(1, Name:="nodes", DataFormat:=Global.ProtoBuf.DataFormat.Default)> _
		Public ReadOnly Property nodes As Global.System.Collections.Generic.List(Of OSMPBF.Node)
    ...
    Private _dense As OSMPBF.DenseNodes =Nothing
    <Global.ProtoBuf.ProtoMember(2, IsRequired:=False, Name:="dense", DataFormat:=Global.ProtoBuf.DataFormat.Default)> _ 
    <Global.System.ComponentModel.DefaultValue(CType(Nothing, OSMPBF.DenseNodes))> _ 
    Public Property dense As OSMPBF.DenseNodes
		Get 
			Return _dense
		End Get
	
		Set(value As OSMPBF.DenseNodes)
		_dense = value 
			
		End Set
	End Property
    
    Private ReadOnly _ways as Global.System.Collections.Generic.List(Of OSMPBF.Way) = New Global.System.Collections.Generic.List(Of OSMPBF.Way)()
		
	<Global.ProtoBuf.ProtoMember(3, Name:="ways", DataFormat:=Global.ProtoBuf.DataFormat.Default)> _
		Public ReadOnly Property ways As Global.System.Collections.Generic.List(Of OSMPBF.Way)
    ...
    Private ReadOnly _relations as Global.System.Collections.Generic.List(Of OSMPBF.Relation) = New Global.System.Collections.Generic.List(Of OSMPBF.Relation)()
		
	<Global.ProtoBuf.ProtoMember(4, Name:="relations", DataFormat:=Global.ProtoBuf.DataFormat.Default)> _
		Public ReadOnly Property relations As Global.System.Collections.Generic.List(Of OSMPBF.Relation)
    ...
    Private ReadOnly _changesets as Global.System.Collections.Generic.List(Of OSMPBF.ChangeSet) = New Global.System.Collections.Generic.List(Of OSMPBF.ChangeSet)()
		
	<Global.ProtoBuf.ProtoMember(5, Name:="changesets", DataFormat:=Global.ProtoBuf.DataFormat.Default)> _
		Public ReadOnly Property changesets As Global.System.Collections.Generic.List(Of OSMPBF.ChangeSet)
...
Public Partial Class Info
    ...
    Private _user_sid As UInteger =0
    <Global.ProtoBuf.ProtoMember(5, IsRequired:=False, Name:="user_sid", DataFormat:=Global.ProtoBuf.DataFormat.TwosComplement)> _ 
    <Global.System.ComponentModel.DefaultValue(CType(0, UInteger))> _ 
    Public Property user_sid As UInteger
		Get 
			Return _user_sid
		End Get
    ...
    <Global.ProtoBuf.ProtoMember(6, IsRequired:=False, Name:="visible", DataFormat:=Global.ProtoBuf.DataFormat.Default)> _ 
    <Global.System.ComponentModel.DefaultValue(CType(False, Boolean))> _ 
...
Public Partial Class DenseInfo
    ...
    Private ReadOnly _visible as Global.System.Collections.Generic.List(Of Boolean) = New Global.System.Collections.Generic.List(Of Boolean)()
		
	<Global.ProtoBuf.ProtoMember(6, Name:="visible", DataFormat:=Global.ProtoBuf.DataFormat.Default)> _
		Public ReadOnly Property visible As Global.System.Collections.Generic.List(Of Boolean)
...
Public Partial Class Node
    ...
    Private _info As OSMPBF.Info =Nothing
    <Global.ProtoBuf.ProtoMember(4, IsRequired:=False, Name:="info", DataFormat:=Global.ProtoBuf.DataFormat.Default)> _ 
    <Global.System.ComponentModel.DefaultValue(CType(Nothing, OSMPBF.Info))> _ 
    Public Property info_Property As OSMPBF.Info
		Get 
			Return _info
		End Get
	
		Set(value As OSMPBF.Info)
		_info = value 
...
Public Partial Class DenseNodes
    ...
    Private _denseinfo As OSMPBF.DenseInfo =Nothing
    <Global.ProtoBuf.ProtoMember(5, IsRequired:=False, Name:="denseinfo", DataFormat:=Global.ProtoBuf.DataFormat.Default)> _ 
    <Global.System.ComponentModel.DefaultValue(CType(Nothing, OSMPBF.DenseInfo))> _ 
    Public Property denseinfo_Property As OSMPBF.DenseInfo
		Get 
			Return _denseinfo
		End Get
	
		Set(value As OSMPBF.DenseInfo)
		_denseinfo = value 
...
Public Partial Class Relation
    ...
    Private ReadOnly _types as Global.System.Collections.Generic.List(Of OSMPBF.Relation.MemberType) = New Global.System.Collections.Generic.List(Of OSMPBF.Relation.MemberType)()
		
	<Global.ProtoBuf.ProtoMember(10, Name:="types", DataFormat:=Global.ProtoBuf.DataFormat.TwosComplement)> _
		Public ReadOnly Property types As Global.System.Collections.Generic.List(Of OSMPBF.Relation.MemberType)
